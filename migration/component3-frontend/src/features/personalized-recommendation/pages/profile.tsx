...
function withIntegerSanitize<T extends keyof ProfileForm>(
  ...
  return {
    ...
    onChange: (e: ChangeEvent<HTMLInputElement>) => {
      e.target.value = sanitizeIntegerString(e.target.value);
      reg.onChange(e);
    },
  };
}
...
function withDecimalSanitize<T extends keyof ProfileForm>(
  ...
  return {
    ...reg,
    onChange: (e: ChangeEvent<HTMLInputElement>) => {
      e.target.value = sanitizeDecimalString(e.target.value);
      reg.onChange(e);
    },
  };
}
...
function withTaxYearSanitize<T extends keyof ProfileForm>(
  ...
  return {
    ...reg,
    onChange: (e: ChangeEvent<HTMLInputElement>) => {
      e.target.value = sanitizeTaxYearString(e.target.value);
      reg.onChange(e);
    },
  };
}
