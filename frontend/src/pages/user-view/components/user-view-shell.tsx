...
const NAV_ITEMS = [
  ...
  { key: "transactions", label: "Transactions", icon: Receipt, active: false },
  { key: "tax-strategy", label: "Tax Strategy", icon: TrendingUp, active: false },
  { key: "ai-advisor", label: "AI Advisor", icon: MessageSquare, active: false },
  { key: "recommendations", label: "Recommendations", icon: Sparkles, active: false },
  { key: "profile", label: "Profile", icon: UserRound, active: false },
] as const;
...
export function UserViewShell({ children, subtitle }: UserViewShellProps) {
              ...
              <button
                ...
                className={cn(
                  ...
                  item.active
                    ...
                    : "cursor-not-allowed text-[var(--uv-text-muted)] opacity-60",
                )}
              >
        ...
        <div className="mt-auto rounded-xl border border-[var(--uv-border)] bg-[var(--uv-bg-card)] p-3">
          <div className="flex items-center gap-3">
            ...
            <div className="min-w-0">
              ...
              <p className="truncate text-xs text-[var(--uv-text-muted)]">Taxpayer account</p>
            </div>
          </div>
          <button
            type="button"
      ...
      <div className="flex min-w-0 flex-1 flex-col">
        <header className="flex items-center justify-between border-b border-[var(--uv-border)] px-4 py-4 md:px-8">
          ...
          <div className="flex items-center gap-3">
            ...
            <span className="flex h-9 w-9 items-center justify-center rounded-full bg-[var(--uv-accent)]/20 text-sm font-semibold text-[var(--uv-accent)]">
              {initials(name)}
            </span>
          </div>
        </header>
